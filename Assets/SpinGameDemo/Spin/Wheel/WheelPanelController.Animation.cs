...
namespace SpinGameDemo.Spin
{
    public partial class WheelPanelController
    {
        private Tween SpinWheelToSlice(int sliceIndex)
        {
            ...
            // Calculate forward rotation from current slice to target slice
            float sliceAngle = sliceIndex * 45f;

            float pointerOffset = 90f; 
            ...
            // Ensure we always rotate in the negative direction (clockwise)
